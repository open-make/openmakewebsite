...
{{< expand "Show answer">}}  
We had a lot of technical issues. Over four or five weeks we were able to fully resolve most of them. Sourcing was one of the major issues. Another was to have the consistency amongst other labs as well, it was an issue in terms of getting the same parts. For example, zeolite were all coming from China. That meant we need to import it from China.  Unfortunately it wasn't available at that time because all of it was used up by various other projects in the world. Zeolite was a big shortage that we had to figure out a bridge. We had to figure out where the gas compressors come from because those are coming from China, too. There’ve been a huge supply chain issues. We had a bunch of issues primarily on the supply chain side because we don't manufacture some of these things in India. 
{{< /expand >}}
...
{{< expand "Show answer">}}  
They were part of the calls and then they did use the designs that were shared by us as well. 
{{< /expand >}}
...
{{< expand "Show answer">}}  
We choose GitHub because we were documenting ourselves on GitHub and since the beginning most of our projects are over there. Hackday and plus is  the most systematic to use. Hackday.io fits to us because I know who the cofounder is, he also writes for them. We use that to document and publish our project.
{{< /expand >}}
...
> What was the success you see today?
...
{{< expand "Show answer">}}  
The excitement of it and to be able to build an oxygen concentrator. Further none of us knew hardware before. It was an opportunity to learn and contribute.
{{< /expand >}}
...
> How did you find suitable people with with these needed competences?
...
> Have participants perceived some personal or monetary rewards?

{{< expand "Show answer">}}  
I'm not sure how a lot of folks benefited. Maybe it’s a question we should ask the folks.
{{< /expand >}}

> How did you benefited yourself?
...
{{< expand "Show answer">}}  
It may saved some lives but I don't know. The first one maybe has, and the second one which is the oxygen concentrator might save lives in the future.
{{< /expand >}}
