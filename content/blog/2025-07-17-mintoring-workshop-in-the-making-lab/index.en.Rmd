...
With the student and [Dr. Nelly Mouawad](https://www.fu-berlin.de/sites/mintoring/ueber-uns/team/Mouawad.html "Weitere Informationen") who is coordinating the program, we discussed what open source means (talking quite a lot about licenses), the difference between free (beers) and free (-dom), and how community can be organised (with the example of wikipedia).
...
We also use fusion CAM software to create a Gcode for the CNC milling machine.
Here, we used the engraving mill to cut/engrave the text, and a downward 3mm mill to bore the hole and make the contour.
After a first text engraving at 0.5mm, we used 1mm engraving for the other objects.
