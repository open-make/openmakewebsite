...
How I came to White Rabbit? Well, first, how I came to knowledge transfer? I had a bit of experience of research during my PhD, but it was a bit too narrow, too far away from a direct application. In that sense, a knowledge transfer job is the opposite. It's very close to the application. You see technologies when they're very mature and ready to have an impact. Also, the topics you can cover as a single person are very diverse. In terms of White Rabbit, I had previous experience before coming to CERN, working at the interface of science and policy on the topic of quantum technologies. Since White Rabbit has a certain type of important applications, quantum technologists were initially working in that aspect.
